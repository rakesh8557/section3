...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorMessageDTO> handleGlobalExistException(Exception exception, WebRequest webRequest){
        ErrorMessageDTO errorMessageDTO = new ErrorMessageDTO(webRequest.getDescription(false)
    ...
    public ResponseEntity<ErrorMessageDTO> handleResourceAlreadyExistException(ResourceAlreadyExistException exception, WebRequest webRequest){
        ErrorMessageDTO errorMessageDTO = new ErrorMessageDTO(webRequest.getDescription(false), HttpStatus.CONFLICT, exception.getMessage(), LocalDateTime.now());
    ...
    public ResponseEntity<ErrorMessageDTO> handleResourceNotExistException(ResourceNotExistException exception, WebRequest webRequest) {
        ErrorMessageDTO errorMessageDTO = new ErrorMessageDTO(webRequest.getDescription(false), HttpStatus.NOT_FOUND, exception.getMessage(), LocalDateTime.now());
